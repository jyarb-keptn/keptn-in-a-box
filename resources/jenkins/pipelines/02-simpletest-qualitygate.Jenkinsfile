...
node {
    properties([
        parameters([
         ...
         string(defaultValue: '"${ORDER_STAGING}"', description: 'URI of the application you want to run a test against, remove the trailing slash', name: 'DeploymentURI', trim: false),
