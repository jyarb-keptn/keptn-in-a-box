...
node {
    ...
    properties([
        parameters([
         ...
         string(defaultValue: "${order_url}", description: 'URI of the application you want to run a test against, remove the trailing slash', name: 'DeploymentURI', trim: false),
