...
agent any
    ...
    parameters {
        ...
        string (name: 'URLPaths', defaultValue: '/orange.jsf:homepage;/about-orange.jsf:about;/special-offers.jsp:offers')
   ...
   stage('Annotation-Post') {
    ...
    stage('Initialize Keptn') {
      steps{
        ...
        keptn.downloadFile("https://raw.githubusercontent.com/jyarb-keptn/overview/0.8.4/easytravel-onboarding/shipyard.yaml", 'keptn/shipyard.yaml')
