...
if [[ -d "catalog" ]]; then
    ...
    keptn create service order --project=keptnorders
    ...
    keptn create service catalog --project=keptnorders
    ...
    keptn create service customer --project=keptnorders
    ...
    keptn create service frontend --project=keptnorders
