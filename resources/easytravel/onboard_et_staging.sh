...
if [[ -d "easytravel-frontend" ]]; then
    ...
    keptn create project easytravel --shipyard=./shipyard-staging.yaml
    keptn add-resource --project=easytravel --resource=./shipyard-staging.yaml --resourceUri=shipyard.yaml
