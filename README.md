...
:rotating_light: ALERT: This install uses keptn 0.13.0 :rotating_light:
...
------------- | ------------- | ------------ |
| **kiab** | [0.8.12.2](https://github.com/jyarb-keptn/keptn-in-a-box/tree/0.8.12.2) | keptn 0.13.0 - local install|
| **kiab** | [0.8.12.1](https://github.com/jyarb-keptn/keptn-in-a-box/tree/0.8.12.1) | keptn 0.12.0 - local install|
...
```bash
curl -O https://raw.githubusercontent.com/jyarb-keptn/keptn-in-a-box/0.8.12.1/keptn-in-a-box.sh
```
